  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 32px 16px;">
    ...
    <div style="background: #ffffff; padding: 32px 24px; border-radius: 0 0 12px 12px;">
      ...
      <p style="font-size: 14px; color: #555; margin: 0 0 24px;">
        Tu pedido ha sido confirmado y estamos preparándolo con mucho cariño. Aquí tienes el resumen:
      </p>
      ...
      <div style="background: #f5f1eb; padding: 12px 16px; border-radius: 8px; margin-bottom: 24px;">
        ...
        <p style="margin: 4px 0 0; font-size: 18px; font-family: monospace; font-weight: 700; color: #333; letter-spacing: 1px;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 16px;">
        <thead>
          <tr>
            <th style="text-align: left; padding: 8px 0; border-bottom: 2px solid #4a6741; font-size: 12px; color: #777; text-transform: uppercase; letter-spacing: 0.5px;">Producto</th>
            <th style="text-align: right; padding: 8px 0; border-bottom: 2px solid #4a6741; font-size: 12px; color: #777; text-transform: uppercase; letter-spacing: 0.5px;">Precio</th>
          </tr>
        </thead>
        <tbody>
          ${itemsRows}
      ...
      <div style="border-top: 2px solid #eee; padding-top: 12px;">
        <table style="width: 100%;">
          <tr>
            ...
            <td style="padding: 4px 0; font-size: 14px; color: #555; text-align: right;">${data.subtotal.toFixed(2)} €</td>
          </tr>
          <tr>
            <td style="padding: 4px 0; font-size: 14px; color: #555;">Envío</td>
            <td style="padding: 4px 0; font-size: 14px; color: #555; text-align: right;">${data.shippingCost.toFixed(2)} €</td>
          </tr>
          <tr>
            <td style="padding: 8px 0 0; font-size: 18px; font-weight: 700; color: #333;">Total</td>
            <td style="padding: 8px 0 0; font-size: 18px; font-weight: 700; color: #333; text-align: right;">${data.total.toFixed(2)} €</td>
          </tr>
        </table>
      </div>
      ...
      <div style="margin-top: 32px; text-align: center;">
        ...
        <a href="https://wa.me/34629455043" target="_blank" style="display: inline-block; background: #25D366; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600;">
    ...
    <div style="text-align: center; padding: 24px 16px;">
      <p style="margin: 0; font-size: 12px; color: #999;">
        Floristería Lara, S.L. (B-38081113)<br/>
        C/ San Antonio, 30 — 38202 La Laguna, Tenerife
      </p>
    </div>
  </div>
</body>
