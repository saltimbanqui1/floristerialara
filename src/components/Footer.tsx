          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-start">
              ...
              <div className="flex flex-col items-center md:items-start gap-3">
                ...
                <div className="flex items-start gap-2 text-charcoal-light text-sm">
                  <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  <span>C/ San Antonio, 30<br />38202 La Laguna, Tenerife</span>
                </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <p className="text-charcoal-light text-sm flex items-center gap-1">
                  Hecho con <Heart className="w-4 h-4 text-petal fill-petal" /> en La Laguna
                </p>
              </div>
